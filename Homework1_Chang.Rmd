---
title: "Homework 1: a Gapminder Exercise"
...
The mean life expectancy is `r round(mean(gapminder$lifeExp), digits=2)` 
...
### **Answer Task 1 **
The mean life expectancy is `r round(mean(gapminder$lifeExp), digits=2)` years with a standard deviation of `r round(sd(gapminder$lifeExp), digits=2)`.  The median life expectancy is `r round(median(gapminder$lifeExp), digits=2)` and the sample size is `r round(length(gapminder$lifeExp), digits=2)`,
...
# bubble plot, with focus on Americas and Asia for the year 1992
keepers <- with(gap_with_colors,
...
### **Task 5 link**
[https://github.com/theamazingchang/N741/blob/master/GapminderMarkdown.Rmd]
[https://github.com/theamazingchang/N741/blob/master/GapminderMarkdown.html]
